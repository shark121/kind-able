...
export default function Loading({ size }: { size: number }) {
  return (
    <div className="absolute h-screen w-screen flex items-center justify-center ">
      <div className="animate-spin relative h-[50px] w-[50px] flex items-center justify-center">
        <svg
